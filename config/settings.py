...
Environmental variables triggered in project's env_iip_prc/bin/activate, when using runserver,
  or env_iip_prc/bin/activate_this.py, when using apache via passenger.
"""
...
SECRET_KEY = os.environ['IIP_PRC__SECRET_KEY']
...
USE_TZ = False  # True generates an error in mysql
